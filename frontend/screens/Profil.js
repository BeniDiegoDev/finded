    ...
    return (
      ...
      >
        <ListItem>
          ...
          />
          <ListItem.Content>
            <ListItem.Title style={{ marginVertical: 2, fontSize: 20 }}>
              Prénom Nom
            </ListItem.Title>
            <ListItem.Subtitle
              onPress={() => {
              ...
              style={{ marginVertical: 2, color: "grey" }}
            >
              Éditer mon profil
            </ListItem.Subtitle>
          </ListItem.Content>
        ...
        <ListItem>
          ...
          >
            <ListItem.Title style={{ marginVertical: 2, fontSize: 15 }}>
              Mentions Légales
            </ListItem.Title>
            <ListItem.Title
              style={{ marginVertical: 2, fontSize: 15, color: "red" }}
            >
              Déconnexion
            </ListItem.Title>
          </ListItem.Content>
